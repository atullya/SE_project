...
export const sendOtp = async (req, res) => {
  ...
  try {
    ...
    const message = await client.messages.create({
      ...
      to: `+977${phoneNumber}`, // Nepal's phone number format (+977)
    });

    // Optionally, you can store the OTP here (in a session, database, or cache)

    // Respond with success message and OTP (for testing, you can send the OTP back)
